    ...
    collections: [
      ...
      },
      {
        ...
        fields: [{ type:"object", name:"items", label:"Cases", list:true,
          ui:{ itemProps:(i:any)=>({label:((i?.hidden?"[oculto] ":"")+(i?.title||"")).replace(/\n/g," ")})},
          fields:[ { type:"boolean", name:"hidden", label:"Ocultar este case do site" },
            S("slug","Slug"), S("title","Título",{ui:{component:"textarea"}}), S("client","Cliente"), S("tag","Tag"), S("year","Ano"),
